...
Blockchain technology with smart contracts[[1]](https://bitsonblocks.net/2016/02/01/a-gentle-introduction-to-smart-contracts/) promises to impact our lives in many ways. This technology has the potential to redefine and create new business models and economies, by enabling users to transact with one another in a peer-to-peer manner, without relying on intermediaries.
